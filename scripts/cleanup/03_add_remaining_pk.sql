...
DELETE
FROM olist_customers_dataset a USING olist_customers_dataset b
WHERE
    a.ctid
    < b.ctid
...
DELETE
FROM olist_order_items_dataset a USING olist_order_items_dataset b
WHERE
    a.ctid
    < b.ctid
...
DELETE
FROM olist_order_payments_dataset a USING olist_order_payments_dataset b
WHERE
    a.ctid
    < b.ctid
  AND a.order_id = b.order_id
...
DELETE
FROM olist_order_reviews_dataset a USING olist_order_reviews_dataset b
WHERE
    a.ctid
    < b.ctid
...
DELETE
FROM product_category_name_translation a USING product_category_name_translation b
WHERE
    a.ctid
    < b.ctid
...
INSERT
INTO product_category_name_translation (product_category_name,
                                        product_category_name_english)
VALUES ('pc_gamer',
        'pc_gamer'),
       ('portateis_cozinha_e_preparadores_de_alimentos',
        'portable_kitchen_and_food_preparers') ON
